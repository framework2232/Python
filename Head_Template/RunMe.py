...
def build_head_tags(x):
    with open(x, 'a') as a:
        ...
        if websiteURL != "": a.write('<link rel="canonical" href="' + websiteURL + '">\n')
        a.write('\n')
        a.write('<!-- Style Sheets -->\n')
        if cssIcons != "": a.write('<link rel="stylesheet" href="' + cssIcons + '">\n')
        if cssFonts != "": a.write('<link rel="stylesheet" href="' + cssFonts + '">\n')
        if cssStylePath != "": a.write('<link rel="stylesheet" type="text/css" href="' + cssStylePath + '" >\n')
        a.write('\n')
        ...
        if websiteURLoptional1 != "": a.write('<meta property="og:see_also" content="' + websiteURLoptional1 + '">\n')
        if websiteURLoptional2 != "": a.write('<meta property="og:see_also" content="' + websiteURLoptional2 + '">\n')
        a.write('\n')
        if websiteImageURL != "": a.write('<!-- Open Graph Markup Image -->\n')
        if websiteImageURL != "": a.write('<meta property="og:image" content="' + websiteImageURL + '" />\n')
        if websiteImageURL != "": a.write('<meta property="og:image:secure_url" content="' + websiteImageURL + '">\n')
        if websiteImageURL != "": a.write('<meta property="og:image:type" content="image/jpeg">\n')
        if websiteImageURL != "": a.write('<meta property="og:image:width" content="' + websiteImageWidth + '">\n')
        if websiteImageURL != "": a.write('<meta property="og:image:height" content="' + websiteImageHeight + '">\n')
        if websiteImageURL != "": a.write('\n')
        ...
        a.write('\n')
        if manifestURL != "": a.write('<!-- Manifest -->\n')
        if manifestURL != "": a.write('<link rel="manifest" href="' + manifestURL + '">\n')
        a.write('\n')
        a.write('<!-- Favicons -->\n')
        if faviconICO != "": a.write('<link rel="icon" type="image/x-icon" href="' + faviconICO + '">   <!-- 32px x 32px -->\n')
        if faviconPNG != "": a.write('<link rel="icon" type="image/png" href="' + faviconPNG + '">  <!-- 1,024px x 1,024px ~12kb -->\n')
        if appleTouchIconPNG != "": a.write('<link rel="apple-touch-icon" href="' + appleTouchIconPNG + '"> <!-- 1,024px x 1,024px ~12kb -->\n')
        if logoSVG != "": a.write('<link rel="mask-icon" color="#fff" href="' + logoSVG + '">\n')
        a.write('\n')
        a.write('   <!-- <script>\n')
